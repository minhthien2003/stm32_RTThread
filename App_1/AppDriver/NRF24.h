 ...
 * Logic Process NRF24 wireless program
*/
#ifndef __NRF24_H__
#define __NRF24_H__
#endif
...
/* NRF24 Connect Pin Configurations */
#define NRF24L01P_SPI                     (&hspi1)

#define NRF24L01P_SPI_CS_PIN_PORT         SPI_CSN_GPIO_Port
#define NRF24L01P_SPI_CS_PIN_NUMBER       SPI_CSN_Pin

#define NRF24L01P_CE_PIN_PORT             SPI_CE_GPIO_Port
#define NRF24L01P_CE_PIN_NUMBER           SPI_CE_Pin
#if 0
